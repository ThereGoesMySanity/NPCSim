...
public class Alignment {
	...
	private void setStr() {
		...
		switch(lnc) {
			case LAWFUL: sb.append("Lawful"); break;
			case NEUTRAL:
				if (gne != GNE.NEUTRAL) sb.append("Neutral");
				else sb.append("True");
				break;
			case CHAOTIC: sb.append("Chaotic"); break;
		}
		sb.append(" ");
		switch(gne) {
			case GOOD: sb.append("Good"); break;
			case NEUTRAL: sb.append("Neutral"); break;
			case EVIL: sb.append("Evil"); break;
		}
		str = sb.toString();
	}
	@Override
